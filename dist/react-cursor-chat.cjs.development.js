...
var Presence = _interopDefault(require('@yomo/presencejs'));
...
var Me = /*#__PURE__*/function (_Cursor) {
  ...
  _proto.subscribeMousePosition = function subscribeMousePosition(yomo) {
    ...
    var mousemove$ = rxjs.fromEvent(document, 'mousemove');
    var movement$ = mousemove$.pipe(operators.map(function (event) {
...
var Latency = function Latency(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    fill: "white"
  })), "\xA0", React__default.createElement("span", null, latencyData.meshId), "\xA0", React__default.createElement("span", null, latencyData.latency, "ms"), "\xA0");
};
...
var OtherCursor = function OtherCursor(_ref) {
  ...
  return React.useMemo(function () {
    return React__default.createElement("div", {
      ...
      ref: refContainer
    }, React__default.createElement(CursorIcon, {
      color: cursor.color
      ...
      src: cursor.avatar,
      alt: "avatar"
    }), cursor.name && React__default.createElement("span", {
      className: "online-cursor-wrapper__name"
    }, cursor.name), React__default.createElement(Latency, {
      cursor: cursor,
    ...
    }), msg && React__default.createElement("div", {
...
var MeCursor = function MeCursor(_ref) {
  ...
  return React.useMemo(function () {
    ...
    }), showInput && React__default.createElement("div", {
      className: "online-cursor-wrapper__input-box"
    }, React__default.createElement("span", null, inputValue), React__default.createElement("input", {
      autoFocus: true,
...
var CursorChat$1 = /*#__PURE__*/React.memo(CursorChat);

exports.default = CursorChat$1;
exports.useOnlineCursor = useOnlineCursor;
exports.useRenderPosition = useRenderPosition;
//# sourceMappingURL=react-cursor-chat.cjs.development.js.map
